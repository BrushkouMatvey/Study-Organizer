...
**«Study Organizer»** поможет поставить четкие цели, расставить приоритеты в учёбе, домашние задания не превратятся в мучения, всё необходимое для будет под рукой.

<a name="project_boundaries">

### 1.2.3 Границы проекта
Приложение «Study organaizer» позволит авторизованным пользователям составлять расписание занятий на неделю, добавлять домашние задания, составлять простые и полезные заметки и отмечать важные события.
