...
Проект «Study Organizer» использует **язык программирования C#** и фреймворк **Xamarin** для кроссплатформенной разработки мобильных приложений . Для хранения данных о расписании, преподавателях, заметках и задачах используется компактная встраиваемая СУБД **SQLite**.
...
1. Выход зарегистрированного пользователя из учётной записи
