...
|Функция|Требования|
|---|---|
|Регестрация|Приложение должно запросить у пользователя ввести никнейм, пароль и электронную почту для создания учётной записи. Пользователь должен либо ввести имя, либо отменить действие.|
