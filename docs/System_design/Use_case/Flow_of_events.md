...
2. Пользователь выбирает пункт либо редактирование предмета, либо удаление предмета из расписания;
3. Если пользователь выбрал редактирование предмета, выполняется поток ["Добавить предмет в расписание"](#add_schedule_item);
4. Если пользователь выбрал удаление события, выполняется поток ["Удалить предмет из расписания"](#delete_schedule_item); 
...
2. Пользователь выбирает пункт либо редактирование домашнего задания, либо удаление домашнего задания;
...
4. Если пользователь выбрал удаление события, выполняется вариант использования ["Удалить домашнее задание"](#delete_homework);  
5. Пользователь нажимает кнопку "ОК";
6. Вариант использования завершается.
...
3. Пользователь выбирает пункт либо редактирование события, либо удаление события;
4. Если пользователь выбрал редактирование события, выполняется вариант использования ["Добавить событие"](#add_event);
5. Если пользователь выбрал удаление события, выполняется вариант использования ["Удалить событие"](#delete_event);  
6. Пользователь нажимает кнопку "ОК";
7. Вариант использования завершается.  
...
2. Пользователь выбирает пункт либо редактирование заметки, либо удаление заметки;
3. Если пользователь выбрал редактирование заметки, выполняется вариант использования ["Добавить заметку"](#add_note);
4. Если пользователь выбрал удаление заметки, выполняется вариант использования ["Удалить заметку](#delete_note);  
5. Пользователь нажимает кнопку "ОК";
6. Вариант использования завершается. 
